    ...
    return (
        <div className='charinfo'>
            <div className='charinfo__descr'>
                ...
                <div className='charinfo__descr-text'>
                    <p >
                        ...
                        and the world serpent Jörmungandr.
                        By Sigyn, Loki is the father of Nari and/or Narfi and with the stallion
                        Svaðilfari as the father, Loki gave birth—in the form of a mare—to the
                        eight-legged horse Sleipnir. In addition, Loki is referred to as the father
                        of Váli in the Prose Edda.
                    </p>
                </div>
                <div>
                    <p className='charinfo__comics'>
                        Comics:
                    </p>
                </div>
